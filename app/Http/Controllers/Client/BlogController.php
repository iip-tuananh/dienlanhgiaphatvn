...
class BlogController extends Controller
{
    public function list()
    {
        ...
        ->paginate(12);
        $data['news'] = Blog::where(['status'=>1, 'home_status'=>1])->orderBy('id', 'desc')->limit(10)->get(['id', 'title', 'slug', 'image', 'created_at']);
    ...
    {
        $data['news'] = Blog::where(['status'=>1, 'home_status'=>1])->orderBy('id', 'desc')->limit(5)->get(['id', 'title', 'slug', 'image', 'created_at']);
